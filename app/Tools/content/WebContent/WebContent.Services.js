(function(angular) {
	...
	.factory("WebContentManager",["WebContentService","DataImportManager",
		...
		WebContentManager.prototype.editPath={url:"app.tools.web_contentEdit",id:"web_content_id"};
		WebContentManager.prototype.listPath={url:"app.tools.web_content"};
		...
		WebContentManager.prototype.saveItem=function(item)
		{
			...
			.then( function( si )
			{
				if(si.web_content_id!=item.web_content_id)
				{
					_WebContentManager.editItem(si.web_content_id);
				}
				return si;
			});
		}
		...
		{
			return WebContentService.readNew({content:"<div contenteditable='true'><h2>[Title]</h2><p>[Your content Here]</p></div>"});
		}
		...
		WebContentManager.prototype.loadList=function()
		{
			...
			return this.readList()
	 		.then(function(sr){_web_contentManager.web_contentsList=sr; return sr;});
		}
