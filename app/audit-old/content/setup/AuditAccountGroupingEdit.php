        ...
        <form>
            <div class="row row-sm">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="md-form-group">
                        <input class='md-input' id='txtreport_note_name' ng-model='editedNode.data.cash_flow_parent_code' required>
                        <label class='non-select'>Cash Flow Report Parent</label>
                    </div>
