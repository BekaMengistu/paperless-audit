    ...
    <div class="box-body ">
        <form>
            ...
            <div class="row">
            	<div class="col-md-3">
                    <div class="md-form-group">
                        <select class='md-input' placeholder="Select Value" ng-model="auditManager.currentAudit.engagementInfo.period0" ng-options="opt.name as opt.description for opt in customLookups.comparative_date"></select>
                ...
                <div class="col-md-3">
                <div class="md-form-group">
                        <select class='md-input' placeholder="Select Value" ng-model="auditManager.currentAudit.engagementInfo.period1" ng-options="opt.name as opt.description for opt in customLookups.comparative_date"></select>
                  		
                        <label>Comparative Date</label>
                    </div>
                </div>

            	<div class="col-md-3">
                    <div class="md-form-group">
                        <select class='md-input' placeholder="Select Value" ng-model="auditManager.currentAudit.engagementInfo.period2" ng-options="opt.name as opt.description for opt in customLookups.comparative_date"></select>
                        <label>Comparative Date2</label>
                    </div>      
                </div>
            	<div class="col-md-3">
                    <div class="md-form-group">
                        <select class='md-input' placeholder="Select Value" ng-model="auditManager.currentAudit.engagementInfo.period3" ng-options="opt.name as opt.description for opt in customLookups.comparative_date"></select>
                        <label>Comparative Date3</label>
                    </div>      
                </div>
