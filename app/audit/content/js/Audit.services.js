...
(function(angular) {
        ...
        var createAuditFormManager=function(formOptions)
        {
            ...
            auditForm.initializeFormManagers=function()
            {
                for(var i in auditForm.forms)
                {
                    ...
                    frm.customForm=CustomFormManager.FormManager({dontLoadScripts:true});
                   // frm.formManager=CustomFormManager.FormManager({dontLoadScripts:true}).manager; 
                    frm.formManager = frm.customForm.manager;
	...
	.service( "AuditService", function( $q,$http )
	{
		return {
            ...
            ,deleteYearEndAdjustments:function(id){return excuteService($q,$http,"api/AuditService/deleteYearEndAdjustments/"+id, {},"get");}
