var bmAuditDependencies={
        "html5.sortable":["libs/html5-sortable-angularjs-master/lib/html5-sortable.js"]
			,"bm.audit":[
                ...
                ,"bm_audit_fs":["app/audit/content/js/custom_report.Services.js"]
                ,"bm_audit_fs2":["api/reportService/getDataController/report_data_grid/rd.js"]
					};
			...
			,'app.audit.detail.adjustments': 
            	{
					...
					,resolve:['ui.select',"bm.audit"]
					,data : { title: 'Audit Adjustment',onLoad:"onAuditAdjustmentLoad" }
			...
			,'app.audit.detail.substantive': 
            	{
					...
					,data : { title: 'Substantive Audit',onLoads:"onSubstantivePageLoad" }
            ...
            ,'app.audit.detail.files': 
            	{
					...
					,resolve:["bm.audit"]
					,data : { title: 'Audit Documents',onLoad:"onInputDocLoaded" }
             ...
             ,'app.audit.detail.printables.fs': 
            	{
					...
					,resolve:["bm_audit_fs2","bm.audit","html5.sortable"]
