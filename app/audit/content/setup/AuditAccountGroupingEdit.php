        ...
        <form>
            <div class="row row-sm">
                <div class="col-sm-6">
                    ...
                    <div class="md-form-group">
                        <input class='md-input' id='txtreport_note_name' ng-model='editedNode.data.second_parent' required>
                        <label class='non-select'>second_parent</label>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="md-form-group">
                    ...
                    <div class="md-form-group">
                        <input class='md-input'  ng-model='editedNode.data.third_parent' required>
                        <label class='non-select'>third_parent</label>
                    </div>
