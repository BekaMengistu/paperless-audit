...
<div class="padding" bm-ui-permission="app.crud.audit_account_grouping" login-user="app.loginUser">
    ...
    <div class="box">
        <div class="box-header {{audit_account_groupingManager.formData.list.headerStyle}} non-select">
            <h2>{{audit_account_groupingManager.formData.list.title}}</h2>
            <small>{{audit_account_groupingManager.formData.list.subTitle}}</small>
        </div>
        <div class="box-tool">
            <ul class="nav" >
                    ...
                    <div class="dropdown-menu pull-right">
                        ...
                        <div class="dropdown-item dropdown-submenu">
                            ...
                            <div class="dropdown-menu pull-left" role="menu">
                                <a class="dropdown-item" href=""><i class="fa  fa-file-excel-o"></i> Excel</a> 
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table m-b-none table-condenced non-select" ui-jp="footable" data-filter="#filter_AuditAccountGrouping" data-page-size="5">
                    <thead>
                        <tr>
