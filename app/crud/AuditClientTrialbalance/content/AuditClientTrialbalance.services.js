(function(angular) {
	...
	.factory("AuditClientTrialbalanceManager",["AuditClientTrialbalanceService","DataImportManager",
		...
		AuditClientTrialbalanceManager.prototype.formData={
				 	list:{title:"Audit Client Trialbalances"
                    		,subTitle:"List of Audit Client Trialbalances"
                            ,prefix:"audit_client_trialbalance",headerStyle:"dker"}
                            
					,detail:{title:"Audit Client Trialbalance Detail"
                    	,subTitle:"Edit Audit Client Trialbalance"
                        ,prefix:"audit_client_trialbalance",headerStyle:"dker"}
					}
		...
		AuditClientTrialbalanceManager.prototype.newItem=function()
		{
			return AuditClientTrialbalanceService.readNew({});
		}
        ...
        AuditClientTrialbalanceManager.prototype.loadNew=function(params)
		{
			var _AuditClientTrialbalanceManager=this;
			return this.newItem()
	 		.then(function(sr){return _AuditClientTrialbalanceManager.editedAuditClientTrialbalance=sr});
		}
		...
		AuditClientTrialbalanceManager.prototype.loadList=function()
		{
			...
			return this.readList()
	 		.then(function(sr){return _audit_client_trialbalanceManager.audit_client_trialbalancesList=sr; return sr;});
		}
		...
		var AuditClientTrialbalanceManagerFactory={
        	create:function(options)
            	{
                	var _AuditClientTrialbalanceManager=new AuditClientTrialbalanceManager(options);
					for(var i in options)
					{
						_AuditClientTrialbalanceManager[i]=options[i];
					}
					_AuditClientTrialbalanceManager.buildUploader();
					return _AuditClientTrialbalanceManager;
