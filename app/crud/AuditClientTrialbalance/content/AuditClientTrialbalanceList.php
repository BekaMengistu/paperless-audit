...
<div class="padding" bm-ui-permission="app.crud.audit_client_trialbalance" login-user="app.loginUser">
    ...
    <div class="box">
        <div class="box-header {{audit_client_trialbalanceManager.formData.list.headerStyle}} non-select">
            <h2>{{audit_client_trialbalanceManager.formData.list.title}}</h2>
        ...
        <div class="box-tool">
            <ul class="nav" >
                ...
                <li class="nav-item inline">
                    <button uib-tooltip="New" ng-click="audit_client_trialbalanceManager.createItem()" 
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table m-b-none table-condenced non-select" ui-jp="footable" data-filter="#filter_AuditClientTrialbalance" data-page-size="5">
                    <thead>
                        <tr>
                            <td style="width:150px !important;"></td>
                            <th >Audit Engagement Id</th>
<th >Account Id</th>
...
<th >Parent Code</th>
<th >Mapping Checked</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="hover-target hover-shadow" ng-repeat="item in audit_client_trialbalanceManager.audit_client_trialbalancesList track by $index">
                            <td><span class="hover-show">
                                <button uib-tooltip="Edit" class="btn btn-info btn-xs"  
            	ng-click="audit_client_trialbalanceManager.editItem(item.audit_client_trialbalance_id)"> <i class="fa fa-pencil"></i> </button>
                                <button uib-tooltip="Delete" class="btn btn-danger  btn-xs" 
            	ng-click="audit_client_trialbalanceManager.deleteItem(item.audit_client_trialbalance_id)"> <i class="fa fa-trash-o"></i> </button>
                                </span></td>
                            <td>{{item.audit_engagement_id}}</td>
