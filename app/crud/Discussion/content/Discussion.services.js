(function(angular) {
	...
	angular.module( "app")
	.service( "DiscussionService", function( $q,$http )
	{
		return {
	...
	.factory("DiscussionManager",["DiscussionService","DataImportManager",
		...
		DiscussionManager.prototype.loadList=function()
		{
			...
			return this.readList()
	 		.then(function(sr){return _discussionManager.discussionsList=sr; return sr;});
		}
