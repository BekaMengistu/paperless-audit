...
<div class="padding" bm-ui-permission="app.crud.web_content" login-user="app.loginUser">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table class="table m-b-none table-condenced non-select" ui-jp="footable" data-filter="#filter_WebContent" data-page-size="5">
                    <thead>
                        <tr>
...
<th >Archived</th>
                    ...
                    <tbody>
                        <tr class="hover-target hover-shadow" ng-repeat="item in web_contentManager.web_contentsList track by $index">
