angular.module('bmDirective', [])
    .directive('bmValidationError', function() {
        return {
            require: 'ngModel',
            link: function(scope, element, attrs,ctl) {
                scope.$watch(attrs['bmValidationError'],function(errorMsg){
					element[0].setCustomValidity(errorMsg);
					ctl.$setValidity('bmValidationError',errorMsg?false:true);
				});
            }
        };
    });
